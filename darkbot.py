...
async def on_member_join(member):
    ...
    embed.add_field(name = '__Welcome__ ' +member.name ' __to Our Server__',value ='**Hope you will be active here. Check Our server rules and never try to break any rules.**',inline = False)
