...
async def help(ctx):
    ...
    embed.add_field(name = 'd!generalhelp ',value ='Explaines all the commands',inline = False)
    await client.send_message(author,embed=embed)
...
async def generalhelp(ctx):
    ...
    embed.add_field(name = 'd!bottutorial ',value ='Use it like ``d!d!dyno <dyno command name>``',inline = False)
